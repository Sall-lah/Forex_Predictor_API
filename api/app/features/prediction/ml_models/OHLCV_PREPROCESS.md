...
The `extract_ohlcv_features` function generates a comprehensive set of technical indicators and custom features from OHLCV (Open, High, Low, Close, Volume) data. These features are categorized as follows:
...
- **`rsi_42h`, `rsi_35h`, `rsi_28h`, `rsi_21h`, `rsi_14h`, `rsi_7h`**: Relative Strength Index for 42, 35, 28, 21, 14, and 7 periods. Measures the speed and change of price movements, indicating overbought or oversold conditions.
- **`roc_3d`, `roc_2d`, `roc_24h`, `roc_12h`, `roc_4h`, `roc_2h`, `roc_1h`**: Rate of Change for 3 days (72 hours), 2 days (48 hours), 24, 12, 4, 2, and 1 periods. Measures the percentage change in price over a given period, indicating momentum.
...
- **`custom_3d_return`, `custom_2d_return`, `custom_24h_return`**: Percentage change in close price over 3 days (72 hours), 2 days (48 hours), and 24 hours, respectively.
...
- **`custom_3d_volatility`, `custom_2d_volatility`, `custom_24h_volatility`, `custom_12h_volatility`, `custom_4h_volatility`, `custom_2h_volatility`**: Rolling standard deviation of percentage change in close price over 3 days (72 hours), 2 days (48 hours), 24, 12, 4, and 2 hours, respectively. Measures short-term volatility.
- **`custom_close_pos_3d`, `custom_close_pos_2d`, `custom_close_pos_24h`, `custom_close_pos_12h`, `custom_close_pos_4h`, `custom_close_pos_2h`**: The position of the close price within the rolling high-low range over 3 days (72 hours), 2 days (48 hours), 24, 12, 6, and 4 hours, respectively. Normalized to be between 0 and 1.
- **`custom_3d_vol_adj_return`, `custom_2d_vol_adj_return`, `custom_24h_vol_adj_return`, `custom_12h_vol_adj_return`, `custom_4h_vol_adj_return`, `custom_2h_vol_adj_return`**: Volatility-adjusted returns over 3 days (72 hours), 2 days (48 hours), 24, 12, 4, and 2 hours, calculated by dividing the percentage change in close price by the corresponding rolling volatility.