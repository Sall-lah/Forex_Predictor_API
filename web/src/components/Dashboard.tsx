...
<div className="flex space-x-2">
<input className="flex-1 bg-surface-container-low border border-outline-variant/20 rounded-sm px-2 py-1.5 text-xs font-label text-primary focus:ring-1 focus:ring-secondary focus:border-secondary outline-none transition-all" placeholder="0.0000" type="number" value="1.09200"/>
<div className="relative inline-block w-20">
<select className="appearance-none w-full bg-surface-container-low border border-outline-variant/20 rounded-sm px-2 py-1.5 text-[10px] font-bold text-outline uppercase focus:ring-1 focus:ring-secondary outline-none cursor-pointer">
<option>Price</option>
<option>%</option>
